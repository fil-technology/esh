...
| — | "User message looks too big" | Screenshot 2 (zoom crop) | **Not a defect** — measured user + assistant text both exactly 14px in the live build; the screenshot was a zoomed-in crop | No change (verified identical sizing) | ✓ (computed 14px == 14px) | n/a | n/a |
