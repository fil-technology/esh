...
public struct RecommendedModelRegistry: Sendable {
    ...
    public static let defaultModels: [RecommendedModel] = [
        ...
        RecommendedModel(
            ...
            estimatedMemoryGB: 4.8,
            totalDiskSizeGB: 4.5,
            tags: ["default", "balanced", "agentic", "general-purpose", "roleplay"],
            summary: "Balanced first-choice local assistant for everyday chat, drafting, coding help, and agentic tasks — a standard, well-supported architecture verified to run through esh's current runtime.",
            contextWindow: 131072,
