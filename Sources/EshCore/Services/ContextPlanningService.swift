...
// `ContextSnippet` and `ContextPlanningBrief` were moved to Domain/ContextPlanningBrief.swift
// (esh iOS M1) so the portable core can use them without this macOS-only planner.
